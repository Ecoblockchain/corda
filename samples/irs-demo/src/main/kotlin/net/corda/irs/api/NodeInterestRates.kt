 ...
 * for signing.
 */
class NodeInterestRates : AcceptsFileUpload, CordaPluginRegistry() {
    companion object {
    ...
    private class FixSignHandler(val otherParty: Party, val plugin: NodeInterestRates) : FlowLogic<Unit>() {
        @Suspendable
        override fun call() {
    ...
    private class FixQueryHandler(val otherParty: Party, val plugin: NodeInterestRates) : FlowLogic<Unit>() {
        companion object {
